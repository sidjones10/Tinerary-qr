...
const templates: Record<string, { subject: string; html: string }> = {
  ...
  newFollower: {
    ...
    html: postcardEmail(`
      ...
      <div style="background:#2c2420;padding:40px 36px;text-align:center;">
        <div style="width:80px;height:80px;border-radius:50%;background:#F8F3EF;border:3px solid #D4792C;margin:0 auto 16px;line-height:80px;font-family:'Nohemi','Nunito Sans',sans-serif;font-size:32px;color:#D4792C;font-weight:700;text-align:center;">J</div>
        <div style="font-family:'Nohemi','Nunito Sans',sans-serif;font-weight:700;font-size:26px;color:#FCFAF8;margin-bottom:4px;">${SAMPLE.followerName}</div>
        <div style="font-family:'Nunito Sans',sans-serif;font-size:15px;color:#D4792C;">@${SAMPLE.followerUsername}</div>
      </div>
      ...
      <div style="background:#D4792C;padding:40px 36px;text-align:center;">
        ...
        <a href="${APP_URL}/user/${SAMPLE.followerUsername}" style="display:inline-block;background:#FCFAF8;color:#D4792C;padding:16px 48px;text-decoration:none;border-radius:28px;font-family:'Nohemi','Nunito Sans',sans-serif;font-weight:700;font-size:16px;letter-spacing:0.5px;">Say Hello</a>
      </div>
  ...
  newComment: {
    ...
    html: postcardEmail(`
      ...
      <div style="background:#D4792C;padding:48px 36px;text-align:center;">
        ...
        <h1 style="margin:0;font-family:'Nohemi','Nunito Sans',sans-serif;font-weight:700;font-size:36px;color:#FCFAF8;line-height:1.1;">${SAMPLE.eventTitle}</h1>
      </div>

      <!-- Comment block -->
      <div style="background:#2c2420;padding:40px 36px;text-align:center;">
        <div style="font-family:'Nohemi','Nunito Sans',sans-serif;font-size:11px;text-transform:uppercase;letter-spacing:3px;color:#D4792C;margin-bottom:20px;">${SAMPLE.followerName} says</div>
        <div style="background:rgba(252,250,248,0.08);border-radius:12px;padding:28px 24px;margin:0 auto;max-width:460px;">
          ...
          <div style="font-family:'Nunito Sans',sans-serif;font-style:italic;font-size:17px;color:#FCFAF8;line-height:1.7;padding:0 8px;">${SAMPLE.commentText}</div>
          <div style="text-align:right;font-family:'Nunito Sans',sans-serif;font-size:14px;color:rgba(252,250,248,0.5);margin-top:12px;">&mdash; ${SAMPLE.followerName}</div>
        </div>
      </div>
      ...
      <div style="background:#F8F3EF;padding:28px 36px;text-align:center;">
        ...
        <div style="font-family:'Nohemi','Nunito Sans',sans-serif;font-weight:700;font-size:20px;color:#2c2420;">${SAMPLE.eventTitle}</div>
      </div>
      ...
      <div style="background:#D4792C;padding:40px 36px;text-align:center;">
        ...
        <a href="${APP_URL}/event/${SAMPLE.eventId}" style="display:inline-block;background:#FCFAF8;color:#D4792C;padding:16px 48px;text-decoration:none;border-radius:28px;font-family:'Nohemi','Nunito Sans',sans-serif;font-weight:700;font-size:16px;letter-spacing:0.5px;">Join the Conversation</a>
      </div>
  ...
  summerPlanning: {
    subject: "What will your summer 2026 look like?",
    html: postcardEmail(`
      <!-- Logo banner -->
      <div style="background:#F8F3EF;padding:28px 36px;text-align:center;">
        <img src="${APP_URL}/email/tinerary-logo.png" alt="Tinerary" style="width:180px;height:auto;" width="180">
